...
def download_my_github_code(path):
    filename = path.rsplit("/")[-1]
    os.system("wget https://raw.githubusercontent.com/ThomasMrY/GooglePlatform/master/{} -O {}".format(path, filename))
...
def setup_week4():
    setup_common()
    download_my_github_code("dsprites_ndarray_co1sh3sc6or40x32y32_64x64.npz")
    import download_utils
